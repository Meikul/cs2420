...
int main()
{
  ...
  cout << "    Finding Three" << endl;
  cout << inventory.find(4060).key << " " << inventory.find(4060).name << endl;
  cout << inventory.find(4550).key << " " << inventory.find(4550).name << endl;
  cout << inventory.find(3177).key << " " << inventory.find(3177).name << endl << endl;
